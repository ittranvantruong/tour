                ...
                <div class="row product_single products">
                    <div class="col-lg-6">
                        <div class="fotorama" data-nav="thumbs" data-transition="crossfade" data-allowfullscreen="true"
                            data-fit="cover" data-maxwidth="100%" data-width="100%">
                            <img src="{{ asset($tour->avatar) }}" class="w-100">
                    ...
                    <div class="col-lg-6 product_desc">
                        ...
                        <div class="thongtin_tour row">
                            <div class="col-md-6">
                                ...
                                <span><a
                                        href="{{ route('search.index', ['sel_place_from' => optional($tour->get_place_from)->id]) }}">{{ optional($tour->get_place_from)->title }}</a></span>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row lienhe_box">
                            <div class="col-md-6">
                                <a href="https://zalo.me/{{$setting['site_zalo']}}" target="_blank"><i
                                        class="fab fa-telegram-plane"></i>Liên hệ</a>
                            </div>
                            <div class="col-md-6">
                                <a href="tel:{{ $setting['site_hotline'] }}"><i
                                        class="fas fa-phone-alt"></i>{{ $setting['site_hotline'] }}</a>
                            </div>
                        </div>
                        <hr />
                        <div class="tags_lienquan">
                            <div>
                                Tags:
                                <a class="tags"
                                    href="{{ route('search.index', ['sel_place_from' => optional($tour->get_place_from)->id]) }}"
                                    rel="tag">
                    ...
                    <div class="col-lg-9 noidungtour">
                        <nav class="d-none d-md-block show_on_desk">
                            <div class="nav nav-tabs">
                                <a class="nav-item nav-link active" data-bs-toggle="tab" href="#chuong-trinh" role="tab"
                                    aria-controls="nav-home" aria-selected="true">Chương trình tour</a>
                                <a class="nav-item nav-link" data-bs-toggle="tab" href="#dieu-khoan" role="tab"
                                    aria-controls="nav-profile" aria-selected="false">Điều khoản</a>
                                <a class="nav-item nav-link" data-bs-toggle="tab" href="#quy-dinh" role="tab"
                                    aria-controls="nav-contact" aria-selected="false">Quy định</a>
                                ...
                                <nav class="hidden_on_desk dropdown-menu">
                                    <div class="nav nav-tabs">
                                        <a class="nav-item nav-link active" data-bs-toggle="tab" href="#chuong-trinh"
                                            onclick="changeTabTitle('Chương trình tour')" role="tab"
                                            aria-controls="nav-home" aria-selected="true">Chương trình tour</a>
                                        <a class="nav-item nav-link" data-bs-toggle="tab" href="#dieu-khoan"
                                            onclick="changeTabTitle('Điều khoản')" role="tab" aria-controls="nav-profile"
                                            aria-selected="false">Điều khoản</a>
                                        <a class="nav-item nav-link" data-bs-toggle="tab" href="#quy-dinh"
                                            onclick="changeTabTitle('Quy định')" role="tab" aria-controls="nav-contact"
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="chuong-trinh" role="tabpanel"
