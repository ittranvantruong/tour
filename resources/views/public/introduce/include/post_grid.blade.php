<div class="row post_single">
    <div class="col-md-4">
        <div class="image-wrapper">
            <a
                href="{{ route('introduction.show', ['category_slug' => $category->slug, 'post_slug' => $item->slug]) }}">
    ...
    <div class="col-md-7 d-flex justify-content-between flex-column">
        <div>
            ...
            <ul class="posted_at">
                ...
                <li><i class="fas fa-certificate"></i> <a  href="{{ route('introduction.category', ['category_slug' => $category->slug]) }}"> {{ $category->title }}</a></li>
            </ul>
        </div>
        <div class="read_continue">
            <a
                href="{{ route('introduction.show', ['category_slug' => $category->slug, 'post_slug' => $item->slug]) }}">Xem
