    ...
    <div class="row">
        <div class="col-4">
            <div class="image-wrapper">
                <a
                    href="{{ route('introduction.show', ['category_slug' => $item->category->slug, 'post_slug' => $item->slug]) }}">
        ...
        <div class="col-8 product_text">
            <a href="{{ route('introduction.show', ['category_slug' => $item->category->slug, 'post_slug' => $item->slug]) }}">
