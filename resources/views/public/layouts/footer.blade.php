    ...
    <section class="container pt-3">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-3 pb-3">
                ...
                <p> </p>
                <p class="m-0"><a href="{{ route('index') }}"><i class="fa fa-caret-right" aria-hidden="true"></i> Trang chủ</a></p>
                <p class="m-0"><a href="{{ route('introduction') }}"><i class="fa fa-caret-right" aria-hidden="true"></i> Giới thiệu</a></p>
                <p class="m-0"><a href="{{ route('tour.index') }}"><i class="fa fa-caret-right" aria-hidden="true"></i> Sản phẩm</a></p>
                <p class="m-0"><a href="{{ route('contact') }}"><i class="fa fa-caret-right" aria-hidden="true"></i> Liên hệ</a></p>
            </div>
            ...
            <div class="col-12 col-md-3 pb-3">
                ...
                <p class="m-0 pb-1">
                    <a href="{{ route('post.show', ['category_slug' => $item->category()->value('slug'), 'post_slug' => $item->slug]) }}"><strong>{{ $item->title }}</strong>
