...
@section('content')
    ...
    <div class="container-fluid">
        <!-- Content Row -->
        <form id="formAdd" action="{{ route('admin.bai-viet.update',$post->id) }}" method="post" data-parsley-validate>
            {{ method_field('put') }}
            @csrf
            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="category_id" id="" class="form-control select2" required   data-parsley-required-message="Bắt buộc chọn danh mục">
                                            <option value="">--Chọn danh mục--</option>
                                            @foreach ($category_posts as $item)
                                                <option value="{{ $item->id }}" {{$post->category_id == $item->id ? 'selected' : '' }}>{{ $item->title }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
