...
class PlaceTourRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        if($this->method() == 'POST'){
            return [
                ...
                'group' => ['required', 'max:255', 'in:'.implode(',', collect(config('custom.tour.group'))->keys()->all())],
            ...
            return [
                ...
                'id' => ['required', 'exists:App\Models\Place,id']
            ];
        }
